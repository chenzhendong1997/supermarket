  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="topbar-info"> <a rel="nofollow" class="link" href="${ctx}/pass/login">登录</a><span class="sep">|</span><a rel="nofollow" class="link" href="${ctx}/pass/register">注册</a><span class="sep">|</span><a rel="nofollow" class="link" href="${ctx}/pass/admin">后台登录</a></div>
        </c:if>
      </div>
    </div>
  </div>
