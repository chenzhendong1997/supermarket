...
<html>
 ...
 <link rel="stylesheet" href="../../../static/os/css/login.css" type="text/css"></link>
 <script type="text/javascript" src="../../../static/os/js/jquery-1.8.3.js"></script>
 <script type="text/javascript" src="../../../static/os/js/login.js"></script>
 </head>
<body>
	<div id="container">
		<div id="top"></div>
